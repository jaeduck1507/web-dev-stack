...
<body>
	<div class="container">
		...
		<nav>
				<ul class="pagination">
					<li class="page-item ${paging.prev ? '' : 'disabled'}"><a class="page-link" href="/list?page=${paging.startPage - 1}${search == null ? '' : '&amp;search='}${search}">Previous</a></li>
					
					<c:forEach begin="${paging.startPage}" end="${paging.endPage}" var="page">
						<li class="page-item"><a class="page-link ${paging.page == page ? 'active' : ''}" href="/list?page=${page}${search == null ? '' : '&amp;search='}${search}">${page}</a></li>
					</c:forEach>
					
					<li class="page-item ${paging.next ? '' : 'disabled'}"><a class="page-link" href="/list?page=${paging.endPage + 1}${search == null ? '' : '&amp;search='}${search}">Next</a></li>
				</ul>
		</nav>
