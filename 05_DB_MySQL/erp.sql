...
EMP_POSITION VARCHAR(10) DEFAULT '수습사원', -- 직위
EMP_JOB VARCHAR(10), -- 직책
EMP_DEPT VARCHAR(10), -- 부서
EMP_JOIN DATE NOT NULL, -- 입사일
EMP_BIRTH DATE,
EMP_STATUS VARCHAR(10), -- 재직 휴직 여부
EMP_SALARY INT
);
