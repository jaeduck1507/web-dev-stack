...
-- 일정 참여 인원 N:M 관계이므로 테이블 하나 생성
-- CREATE TABLE SCHEDULE_MEMBERS(
-- SECHEDULE_MEM_NO INT AUTO_INCREMENT PRIMARY KEY,
-- SCHEDULE_NO INT,
...
CREATE TABLE CUSTOMER(
    ...
    CUSTOMER_DESC TEXT,
    CUSTOMER_GRADE VARCHAR(20) CHECK(STATUS IN ('VVIP','VIP','REGULAR','NEW')),
    CUSTOMER_CATEGORY VARCHAR(20) CHECK(STATUS IN ('개인','기업','국가')),
...
CREATE TABLE CONTRACT(
    ...
    CONTRACT_DESC TEXT,
    CONTRACT_PAY INT , -- 계약금
    CONTRACT_START DATE NOT NULL,
    CONTRACT_END DATE,
    STATUS VARCHAR(30) CHECK(STATUS IN ('계약금 지불 전','계약 완료','계약 내용 이행 완료','파기')),
    CUSTOMER_NO INT,
    USER_NO INT -- 담당자 정보
