...
public class HandlerMapping {
	...
	public Controller createController(String command) {
		...
		else if(command.equals("allMember.do")) controller = new AllMemberController();
		else if(command.equals("search.do")) controller = new SearchController();
		else if(command.equals("logout.do")) controller = new LogoutController();
		return controller;
	}
}
