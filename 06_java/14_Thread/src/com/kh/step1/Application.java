 ...
 * 
 * * 스레드 (일꾼)
 * - 프로세스 내에서 할당된 자원을 잉ㅇ해 실제 작업을 수행하는 작업 단위
 ...
 *  - main() 메서드의 첫 코드부터 아래로 순차적으로 실행되고, 코드를 모두 실행하거나 return 문을 만나면 프로그램 실행이 종료
 *  
 *  * 멀티 스레드
...
//		ComeThread come2 = new ComeThread("ComeThread2");
