...
public class C_Sorting {
	...
	public void method1() {
		...
		// 2. 내림 차순 정렬 -> 원본배열은 따로 있고 새로운 배열을 생성
	...
	public void method2() {
		...
		// 내림차순 -> int[] 불가! Integer[] 가능! 안씀 배열 걍 안씀
	 ...
	 * 실제로는 Arrays.sort() 같은 내장 정렬이나 Collections.sort()가 훨씬 빠르고 실용적이기 때문에 몰라도 됨
	 * 
	 * */
