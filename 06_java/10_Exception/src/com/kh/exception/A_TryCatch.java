...
public class A_TryCatch {
	...
	/*
	 * 컴파일 에러(compile-time error) : 컴파일 시에 발생하는 에러 (실행하기 전부터 에러)
	 ...
	 * 		RuntimeException -> ArithmeticException, InexOutofBoundsException
	 * 
	 * try ~ catch
	 * 
	 * try {
	...
	public static void main(String[] args) {
		try {
			throw new Exception(); // 고의로 예외를 발생!
			
		} catch(Exception e) {
			System.out.println("예외 처리!");
			// printStackTrace : 예외발생 당시의 호출 스택 (call stack)에 있었던
