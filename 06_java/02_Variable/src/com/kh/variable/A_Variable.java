...
//		variable.printValue();
	...
	public void variableTest() {
		 ...
		 * - 변수명 : 변수의 이름으로 값을 읽고, 쓰고 지우는 작업을 할때 사용
		 * 
		 * 변수의 초기화
		 * 
		 * 변수명 = 값;
...
//		bNum = 128; -> 에러 발생! 오버플로우(overflow)
		...
		int iNum = 922337283; // 4byte (=32bit) = 2^32 (기본)
		long lNum = 922337283458L; // 8byte = (=64bit) - 숫자 뒤에 L(l)을 입력
...
//		int public;
	...
	public void constant() {
		 ...
		 *  final 자료형 변수명;
		 *  
		 *  - 변하지 않는 값으로 특정 변수의 값이 변경되는 걸 원하지 않을때 사용
